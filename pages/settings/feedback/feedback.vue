<template>
	<view class="page">
		...
		<view class="feedback-body"><textarea placeholder="请详细描述你的问题和意见,不要发送无关信息,筛选很累." v-model="sendDate.content" class="feedback-textare"></textarea></view>
...
<script>
	export default {
		...
		data() {
			return {
				msgContents: ['界面显示bug', '加载缓慢', '任务错误（请详细描述）', '偶发性崩溃'],
				imageList: [],
				sendDate: {
					score: 0,
					content: '',
